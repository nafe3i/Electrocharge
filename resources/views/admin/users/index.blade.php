...
<div class="flex items-center justify-between mb-6">
    <div>
        <h2 class="text-xl font-medium text-gray-800">Utilisateurs</h2>
        <p class="text-sm text-gray-500 mt-1">{{ $users->total() }} utilisateur(s) au total</p>
    </div>
</div>
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
                ...
                <th class="text-center px-4 py-3 text-gray-500 font-medium">Rôle</th>
                <th class="text-center px-4 py-3 text-gray-500 font-medium">Inscrit le</th>
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-green-100 flex items-center
                                        justify-center text-green-700 font-medium text-sm">
