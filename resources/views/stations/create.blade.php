...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-2 mb-6 text-sm">
        ...
        <span class="text-slate-600">Nouvelle station</span>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6">
        ...
        <form method="POST" action="{{ route('admin.stations.store') }}">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                {{-- Opérateur --}}
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1.5">Opérateur</label>
                ...
                <div class="col-span-2">
                    ...
                    <input type="url" name="photo_url" value="{{ old('photo_url') }}"
                           ...
                           class="w-full border rounded-lg px-3 py-2.5 text-sm
                                  focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent
                                  {{ $errors->has('photo_url') ? 'border-red-400' : 'border-slate-200' }}">
                    @error('photo_url')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
